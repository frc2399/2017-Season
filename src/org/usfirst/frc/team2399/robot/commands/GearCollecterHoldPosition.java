 ...
 *
 */
public class GearCollecterHoldPosition extends Command {

	private GearCollector gearCollector = Robot.gearCollector;
    public GearCollecterHoldPosition() {
    ...
    protected void execute() {
    	gearCollector.setGearInSolenoid(false);
    	gearCollector.setGearOutSolenoid(false);
    }
